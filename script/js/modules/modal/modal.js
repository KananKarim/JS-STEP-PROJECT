  ...
  getToken(initBtn, initialEmptyContentTitle, btnToActivate) {
    return new Promise((resolve, reject) => {
      initBtn.addEventListener("click", (e) => {
        ...
        authorizeModalElem.querySelector("#exampleInputEmail1").value = "kenankerimli7770@gmail.com";
        authorizeModalElem.querySelector("#exampleInputPassword1").value = "Kerimov7770";
